      ...
      <section id="hero">
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 flex justify-between">
            <div className="mr-4 flex-col flex flex-1 space-y-1.5">
              <BlurFadeText
                delay={BLUR_FADE_DELAY}
                className="text-3xl font-bold tracking-tighter sm:text-4xl xl:text-6xl/none"
                yOffset={8}
            ...
            <BlurFade delay={BLUR_FADE_DELAY}>
              <Avatar className="w-[7rem] border">
          ...
          <BlurFade delay={BLUR_FADE_DELAY * 11}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl pb-4 pt-2">
